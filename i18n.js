...
// ── Extra placeholder translations ──────────────────────────────────────────
TRANSLATIONS.en['bid.ph_company'] = "e.g. Jose's Plumbing LLC";
TRANSLATIONS.en['bid.ph_contact'] = "e.g. Jose Martinez";
TRANSLATIONS.en['bid.ph_title'] = "e.g. Full bathroom remodel";
TRANSLATIONS.en['bid.ph_scope'] = "Describe the work to be done, timeline, any special conditions...";
TRANSLATIONS.en['bid.ph_item_desc'] = "Description";
TRANSLATIONS.en['exp.amount'] = "Amount";
TRANSLATIONS.en['exp.description'] = "Description";
TRANSLATIONS.en['exp.amount_col'] = "Amount";
TRANSLATIONS.en['exp.total_col'] = "Total";

TRANSLATIONS.es['bid.ph_company'] = "ej. Plomería de José LLC";
TRANSLATIONS.es['bid.ph_contact'] = "ej. José Martínez";
TRANSLATIONS.es['bid.ph_title'] = "ej. Remodelación completa de baño";
TRANSLATIONS.es['bid.ph_scope'] = "Describa el trabajo a realizar, cronograma, condiciones especiales...";
TRANSLATIONS.es['bid.ph_item_desc'] = "Descripción";
TRANSLATIONS.es['exp.amount'] = "Monto";
TRANSLATIONS.es['exp.description'] = "Descripción";
TRANSLATIONS.es['exp.amount_col'] = "Monto";
TRANSLATIONS.es['exp.total_col'] = "Total";

// Fix conn-label on langchange
window.addEventListener('langchange', function() {
  const connLabel = document.getElementById('conn-label');
  if (connLabel && connLabel.textContent.includes('Live')) {
    connLabel.textContent = t('app.live');
  } else if (connLabel && (connLabel.textContent.includes('Connecting') || connLabel.textContent.includes('Conectando'))) {
    connLabel.textContent = t('app.connecting');
  }
  // Re-apply to catch any missed elements
  applyTranslations();
});

// ── Auto-added dynamic content translations ─────────────────────────────
TRANSLATIONS.en['exp.add_expense'] = 'Add expense';
TRANSLATIONS.en['exp.all_expenses'] = 'All expenses';
TRANSLATIONS.en['exp.col_project'] = 'Project';
TRANSLATIONS.en['exp.col_desc'] = 'Description';
TRANSLATIONS.en['exp.col_amount'] = 'Amount';
TRANSLATIONS.en['exp.col_category'] = 'Category';
TRANSLATIONS.en['exp.col_paid_by'] = 'Paid by';
TRANSLATIONS.en['exp.col_reimb'] = 'Reimb.';
TRANSLATIONS.en['exp.col_status'] = 'Status';
TRANSLATIONS.en['exp.add_btn'] = 'Add expense';
TRANSLATIONS.en['exp.no_data'] = 'No expenses yet.';
TRANSLATIONS.en['payments.notice'] = 'Track partial payments per approved bid. All data saves to Supabase in real time.';
TRANSLATIONS.en['payments.no_data'] = 'No approved bids yet.';
TRANSLATIONS.en['payments.add_payment'] = 'Add payment';
TRANSLATIONS.en['payments.paid'] = 'Paid';
TRANSLATIONS.en['payments.outstanding'] = 'Outstanding';
TRANSLATIONS.en['payments.labor'] = 'Labor';
TRANSLATIONS.en['payments.materials'] = 'Materials';
TRANSLATIONS.en['general.add_project'] = 'Add project';
TRANSLATIONS.en['general.active_projects'] = 'Active projects';
TRANSLATIONS.en['general.proj_name'] = 'Project name';
TRANSLATIONS.en['general.partners'] = 'Partners';
TRANSLATIONS.en['general.street_addr'] = 'Street address';
TRANSLATIONS.en['general.save_supabase'] = 'Save to Supabase';
TRANSLATIONS.en['general.bids_label'] = 'bids';
TRANSLATIONS.en['general.expenses_label'] = 'expenses';
TRANSLATIONS.en['general.copy'] = 'Copy';
TRANSLATIONS.en['general.remove'] = 'Remove';
TRANSLATIONS.en['general.view_dash'] = '→ view dashboard';
TRANSLATIONS.en['general.bid_link_lbl'] = '📋 Bid link:';
TRANSLATIONS.en['general.exp_link_lbl'] = '💵 Expense link:';
TRANSLATIONS.en['general.no_projects'] = 'No projects yet.';
TRANSLATIONS.en['reimb.by_person'] = 'By person';
TRANSLATIONS.en['reimb.by_project'] = 'By project';
TRANSLATIONS.en['reimb.rejected_log'] = 'Rejected log';
TRANSLATIONS.en['reimb.outstanding'] = 'Outstanding';
TRANSLATIONS.en['reimb.item'] = 'Item';
TRANSLATIONS.en['reimb.project'] = 'Project';
TRANSLATIONS.en['reimb.date'] = 'Date';
TRANSLATIONS.en['reimb.cost'] = 'Cost';
TRANSLATIONS.en['reimb.reimbursed'] = 'Reimbursed';
TRANSLATIONS.en['reimb.notice'] = 'Approved expenses are added to actual project costs automatically. Toggle reimbursed to track who has been paid back.';
TRANSLATIONS.en['reimb.no_approved'] = 'No approved expenses yet.';
TRANSLATIONS.en['reimb.no_rejected'] = 'No rejected expenses.';
TRANSLATIONS.en['reimb.queue_clear'] = 'Queue is clear';
TRANSLATIONS.en['reimb.all_reviewed'] = 'All expenses reviewed';
TRANSLATIONS.en['reimb.pending_notice'] = 'Expenses here have zero effect on actual project costs until you approve them.';
TRANSLATIONS.en['people.bids'] = 'Bids';
TRANSLATIONS.en['people.expenses'] = 'Expenses';
TRANSLATIONS.en['people.total_outstanding'] = 'Total outstanding';
TRANSLATIONS.en['people.total'] = 'total';
TRANSLATIONS.en['people.approved'] = 'approved';
TRANSLATIONS.en['people.approved_value'] = 'approved value';
TRANSLATIONS.en['people.paid_out'] = 'paid out';
TRANSLATIONS.en['people.outstanding'] = 'outstanding';
TRANSLATIONS.en['people.to_reimburse'] = 'to reimburse';
TRANSLATIONS.en['people.unpaid'] = 'Unpaid';
TRANSLATIONS.en['people.no_people'] = 'No people or subcontractors yet.';
TRANSLATIONS.en['status.sp'] = 'Pending';
TRANSLATIONS.en['status.sa'] = 'Approved';
TRANSLATIONS.en['status.sr'] = 'Rejected';
TRANSLATIONS.en['status.sv'] = 'Revision';
TRANSLATIONS.en['bid.no_bids'] = 'No bids yet.';
TRANSLATIONS.en['bid.no_pending'] = 'No pending bids.';
TRANSLATIONS.en['queue.all_clear'] = '✓ Queue is clear';
TRANSLATIONS.en['queue.all_reviewed'] = 'All bids reviewed';
TRANSLATIONS.en['queue.approve'] = 'Accept bid';
TRANSLATIONS.en['queue.reject'] = 'Reject bid';
TRANSLATIONS.en['queue.revision'] = 'Request revision';
TRANSLATIONS.en['queue.revision_note'] = 'Revision note';
TRANSLATIONS.en['queue.pending_notice'] = 'Bids here have zero effect on actual costs until you approve them.';
TRANSLATIONS.en['queue.approve_actuals'] = 'Approve — add to actuals';
TRANSLATIONS.es['exp.add_expense'] = 'Agregar gasto';
TRANSLATIONS.es['exp.all_expenses'] = 'Todos los gastos';
TRANSLATIONS.es['exp.col_project'] = 'Proyecto';
TRANSLATIONS.es['exp.col_desc'] = 'Descripción';
TRANSLATIONS.es['exp.col_amount'] = 'Monto';
TRANSLATIONS.es['exp.col_category'] = 'Categoría';
TRANSLATIONS.es['exp.col_paid_by'] = 'Pagado por';
TRANSLATIONS.es['exp.col_reimb'] = 'Reemb.';
TRANSLATIONS.es['exp.col_status'] = 'Estado';
TRANSLATIONS.es['exp.add_btn'] = 'Agregar gasto';
TRANSLATIONS.es['exp.no_data'] = 'Sin gastos aún.';
TRANSLATIONS.es['payments.notice'] = 'Registre pagos parciales por oferta aprobada. Todos los datos se guardan en Supabase en tiempo real.';
TRANSLATIONS.es['payments.no_data'] = 'Sin ofertas aprobadas aún.';
TRANSLATIONS.es['payments.add_payment'] = 'Agregar pago';
TRANSLATIONS.es['payments.paid'] = 'Pagado';
TRANSLATIONS.es['payments.outstanding'] = 'Pendiente';
TRANSLATIONS.es['payments.labor'] = 'Mano de obra';
TRANSLATIONS.es['payments.materials'] = 'Materiales';
TRANSLATIONS.es['general.add_project'] = 'Agregar proyecto';
TRANSLATIONS.es['general.active_projects'] = 'Proyectos activos';
TRANSLATIONS.es['general.proj_name'] = 'Nombre del proyecto';
TRANSLATIONS.es['general.partners'] = 'Socios';
TRANSLATIONS.es['general.street_addr'] = 'Dirección';
TRANSLATIONS.es['general.save_supabase'] = 'Guardar en Supabase';
TRANSLATIONS.es['general.bids_label'] = 'ofertas';
TRANSLATIONS.es['general.expenses_label'] = 'gastos';
TRANSLATIONS.es['general.copy'] = 'Copiar';
TRANSLATIONS.es['general.remove'] = 'Eliminar';
TRANSLATIONS.es['general.view_dash'] = '→ ver panel';
TRANSLATIONS.es['general.bid_link_lbl'] = '📋 Enlace de oferta:';
TRANSLATIONS.es['general.exp_link_lbl'] = '💵 Enlace de gastos:';
TRANSLATIONS.es['general.no_projects'] = 'Sin proyectos aún.';
TRANSLATIONS.es['reimb.by_person'] = 'Por persona';
TRANSLATIONS.es['reimb.by_project'] = 'Por proyecto';
TRANSLATIONS.es['reimb.rejected_log'] = 'Registro de rechazados';
TRANSLATIONS.es['reimb.outstanding'] = 'Pendiente';
TRANSLATIONS.es['reimb.item'] = 'Artículo';
TRANSLATIONS.es['reimb.project'] = 'Proyecto';
TRANSLATIONS.es['reimb.date'] = 'Fecha';
TRANSLATIONS.es['reimb.cost'] = 'Costo';
TRANSLATIONS.es['reimb.reimbursed'] = 'Reembolsado';
TRANSLATIONS.es['reimb.notice'] = 'Los gastos aprobados se agregan automáticamente a los costos reales del proyecto.';
TRANSLATIONS.es['reimb.no_approved'] = 'Sin gastos aprobados aún.';
TRANSLATIONS.es['reimb.no_rejected'] = 'Sin gastos rechazados.';
TRANSLATIONS.es['reimb.queue_clear'] = 'Cola limpia';
TRANSLATIONS.es['reimb.all_reviewed'] = 'Todos los gastos revisados';
TRANSLATIONS.es['reimb.pending_notice'] = 'Los gastos aquí no afectan los costos reales del proyecto hasta que los apruebe.';
TRANSLATIONS.es['people.bids'] = 'Ofertas';
TRANSLATIONS.es['people.expenses'] = 'Gastos';
TRANSLATIONS.es['people.total_outstanding'] = 'Total pendiente';
TRANSLATIONS.es['people.total'] = 'total';
TRANSLATIONS.es['people.approved'] = 'aprobado';
TRANSLATIONS.es['people.approved_value'] = 'valor aprobado';
TRANSLATIONS.es['people.paid_out'] = 'pagado';
TRANSLATIONS.es['people.outstanding'] = 'pendiente';
TRANSLATIONS.es['people.to_reimburse'] = 'a reembolsar';
TRANSLATIONS.es['people.unpaid'] = 'Sin pagar';
TRANSLATIONS.es['people.no_people'] = 'Sin personas o contratistas aún.';
TRANSLATIONS.es['status.sp'] = 'Pendiente';
TRANSLATIONS.es['status.sa'] = 'Aprobado';
TRANSLATIONS.es['status.sr'] = 'Rechazado';
TRANSLATIONS.es['status.sv'] = 'Revisión';
TRANSLATIONS.es['bid.no_bids'] = 'Sin ofertas aún.';
TRANSLATIONS.es['bid.no_pending'] = 'Sin ofertas pendientes.';
TRANSLATIONS.es['queue.all_clear'] = '✓ Cola limpia';
TRANSLATIONS.es['queue.all_reviewed'] = 'Todas las ofertas revisadas';
TRANSLATIONS.es['queue.approve'] = 'Aceptar oferta';
TRANSLATIONS.es['queue.reject'] = 'Rechazar oferta';
TRANSLATIONS.es['queue.revision'] = 'Solicitar revisión';
TRANSLATIONS.es['queue.revision_note'] = 'Nota de revisión';
TRANSLATIONS.es['queue.pending_notice'] = 'Las ofertas aquí no afectan los costos reales hasta que las apruebe.';
TRANSLATIONS.es['queue.approve_actuals'] = 'Aprobar — agregar a reales';
TRANSLATIONS.en['general.reimbursed_done'] = '✓ Reimbursed';
TRANSLATIONS.en['general.paid_done'] = '✓ Paid';
TRANSLATIONS.en['general.mark_paid'] = 'Mark paid';
TRANSLATIONS.en['general.mark_reimbursed'] = 'Mark reimbursed';
TRANSLATIONS.es['general.reimbursed_done'] = '✓ Reembolsado';
TRANSLATIONS.es['general.paid_done'] = '✓ Pagado';
TRANSLATIONS.es['general.mark_paid'] = 'Marcar pagado';
TRANSLATIONS.es['general.mark_reimbursed'] = 'Marcar reembolsado';
TRANSLATIONS.en['general.bids_label'] = 'bids';
TRANSLATIONS.en['general.expenses_label'] = 'expenses';
TRANSLATIONS.es['general.bids_label'] = 'ofertas';
TRANSLATIONS.es['general.expenses_label'] = 'gastos';
TRANSLATIONS.en['general.partners'] = 'Partners';
TRANSLATIONS.es['general.partners'] = 'Socios';
TRANSLATIONS.en['general.total'] = 'total';
TRANSLATIONS.es['general.total'] = 'total';
TRANSLATIONS.en['people.total'] = 'total';
TRANSLATIONS.es['people.total'] = 'total';
TRANSLATIONS.en['people.approved'] = 'approved';
TRANSLATIONS.es['people.approved'] = 'aprobado';
