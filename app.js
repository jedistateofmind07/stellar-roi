...
async function addProject() {
  ...
  const { data, error } = await db.from('projects').insert({ name, address: document.getElementById('pj-addr').value.trim(), city: document.getElementById('pj-city').value.trim(), partners: document.getElementById('pj-partners').value.trim() }).select();
